...
import com.nazarii.shostachuk.tkhelper.networktools.ping.PingTools;
...
public class Ping {
    ...
    public PingHolder doPingWithTimes() {

        PingHolder pingHolder = new PingHolder();
        ArrayList<PingResult> pingResults = new ArrayList<>();
        ...
        pingHolder.setPingStats(new PingStats(address, pingsCompleted, noLostPackets, totalPingTime, minPingTime, maxPingTime));
        pingHolder.setPingResults(pingResults);
